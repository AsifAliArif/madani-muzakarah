...
export default function LoginPage() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-section">
      <div className="bg-white rounded-card shadow-lg p-8 max-w-md w-full mx-4 text-center">
        <h1 className="font-title text-3xl text-primary mb-4">مدنی مذاکرہ ڈیٹا بیس</h1>
        <p className="text-gray-600 mb-8">جاری رکھنے کے لیے Google سے لاگ ان کریں</p>
        <button
          type="button"
          onClick={() => api.login()}
          className="w-full py-3 bg-primary text-white rounded-full text-lg hover:bg-primary-light min-h-[48px] flex items-center justify-center gap-3"
        >
